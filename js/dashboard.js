...
<div class="os-container view-animate">
            ...
            <div class="hero-actions">
                ...
                <div class="daily-mission-card glass-inset">
                    ...
                    <div class="mission-header">
                        ...
                        <span id="mission-percent" class="accent">
    ...
    <section class="metric-hub">
        ...
        <div class="os-card glass-v2 tilt-card metric-card">
            ...
            <div class="metric-icon streak-glow">
        ...
        <div class="os-card glass-v2 tilt-card metric-card">
            ...
            <div class="metric-icon focus-glow">
...
`,
    ...
    renderStats() {
        ...
        document.getElementById(
            ...
            `WELCOME, ${data.profile.name.toUpperCase()
